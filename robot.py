...
def reset(self):
        """ 
        Surcharge de la fonction reset pour appliquer l'orientation 
        spécifique au sous-essai actuel.
        """
        # On remet à zéro les compteurs et les positions via le parent
        super().reset() 
        # On impose l'orientation prévue pour ce sous-essai
